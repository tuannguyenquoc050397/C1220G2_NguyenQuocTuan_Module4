...
import com.example.demo.service.DuplicateNameException;
...
public class BlogController {
    ...
    public ModelAndView showDetail( @PathVariable String id){
        ...
        return new ModelAndView("blog/detail","blog",blogService.findById(Long.valueOf(id)));
    }
    ...
    @PostMapping("create")
    public ModelAndView createBlog(Blog blog, @PageableDefault(value = 3) Pageable pageable) throws DuplicateNameException {
